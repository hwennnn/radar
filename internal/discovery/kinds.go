...
func IsStructuredKind(kind string) bool {
	...
	switch kind {
	case "greenhouse", "lever", "ashby", "smartrecruiters", "workable", "workable_jobs", "recruitee", "comeet", "workday", "breezy", "personio", "pinpoint", "polymer", "icims", "jazzhr", "gem", "avature", "jobvite", "teamtailor", "bamboohr",
		"rippling", "rippling_jobs", "successfactors", "adp_workforcenow", "adp_myjobs", "ukg", "dayforce", "oracle_recruiting", "paylocity", "paycom", "dover", "recruiterbox", "github_job_list", "hireology", "zoho_recruit", "manatal", "join_com",
		"workstream", "jobscore", "jobsoid", "freshteam", "homerun", "catsone", "hibob_hiring", "occupop", "fountain", "applicantpro", "talentbrew", "talentlyft", "phenom_people", "jibe", "openai_careers", "apple_jobs", "stripe_jobs", "amazon_jobs",
		"google_careers", "eightfold_pcsx", "microsoft_careers", "jobylon", "careerplug", "taleo", "snowflake_careers", "janestreet_careers", "akuna_careers", "citadel_careers", "citadel_securities_careers", "meta_careers", "optiver_careers":
		return true
	}
	return strings.Contains(kind, "greenhouse") ||
		strings.Contains(kind, "lever") ||
		strings.Contains(kind, "ashby") ||
		strings.Contains(kind, "smartrecruiters") ||
		strings.Contains(kind, "workable") ||
		strings.Contains(kind, "recruitee") ||
		strings.Contains(kind, "comeet") ||
		strings.Contains(kind, "workday") ||
		strings.Contains(kind, "breezy") ||
		strings.Contains(kind, "personio") ||
		strings.Contains(kind, "pinpoint") ||
		strings.Contains(kind, "polymer") ||
		strings.Contains(kind, "icims") ||
		strings.Contains(kind, "jazzhr") ||
		strings.Contains(kind, "gem") ||
		strings.Contains(kind, "avature") ||
		strings.Contains(kind, "jobvite") ||
		strings.Contains(kind, "teamtailor") ||
		strings.Contains(kind, "bamboohr") ||
		strings.Contains(kind, "stripe_jobs") ||
		strings.Contains(kind, "rippling_jobs") ||
		strings.Contains(kind, "successfactors") ||
		strings.Contains(kind, "adp_workforcenow") ||
		strings.Contains(kind, "adp_workforce_now") ||
		strings.Contains(kind, "workforcenow") ||
		strings.Contains(kind, "adp_myjobs") ||
		strings.Contains(kind, "adp_my_jobs") ||
		strings.Contains(kind, "myjobs") ||
		strings.Contains(kind, "ukg") ||
		strings.Contains(kind, "ultipro") ||
		strings.Contains(kind, "dayforce") ||
		strings.Contains(kind, "oracle_recruiting") ||
		strings.Contains(kind, "oracle_cloud_recruiting") ||
		strings.Contains(kind, "paylocity") ||
		strings.Contains(kind, "paycom") ||
		strings.Contains(kind, "dover") ||
		strings.Contains(kind, "recruiterbox") ||
		strings.Contains(kind, "trakstar") ||
		strings.Contains(kind, "github_job_list") ||
		strings.Contains(kind, "hireology") ||
		strings.Contains(kind, "zoho_recruit") ||
		strings.Contains(kind, "manatal") ||
		strings.Contains(kind, "join_com") ||
		strings.Contains(kind, "workstream") ||
		strings.Contains(kind, "jobscore") ||
		strings.Contains(kind, "jobsoid") ||
		strings.Contains(kind, "freshteam") ||
		strings.Contains(kind, "homerun") ||
		strings.Contains(kind, "catsone") ||
		strings.Contains(kind, "hibob_hiring") ||
		strings.Contains(kind, "occupop") ||
		strings.Contains(kind, "fountain") ||
		strings.Contains(kind, "applicantpro") ||
		strings.Contains(kind, "talentbrew") ||
		strings.Contains(kind, "talentlyft") ||
		strings.Contains(kind, "phenom") ||
		strings.Contains(kind, "jibe") ||
		strings.Contains(kind, "snowflake_careers") ||
		strings.Contains(kind, "janestreet_careers") ||
		strings.Contains(kind, "akuna_careers") ||
		strings.Contains(kind, "openai_careers") ||
		strings.Contains(kind, "apple_jobs") ||
		strings.Contains(kind, "amazon_jobs") ||
		strings.Contains(kind, "google_careers") ||
		strings.Contains(kind, "eightfold") ||
		strings.Contains(kind, "pcsx") ||
		strings.Contains(kind, "microsoft_careers") ||
		strings.Contains(kind, "jobylon") ||
		strings.Contains(kind, "taleo")
}
